...
- (void)readImageFromAlbum {
    ...
    if (device) {
        ...
        if (status == PHAuthorizationStatusNotDetermined) { // 用户还没有做出选择
            ...
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"⚠️ 警告" message:@"请去-> [设置 - 隐私 - 照片 - ShadowBit] 打开访问开关" preferredStyle:(UIAlertControllerStyleAlert)];
